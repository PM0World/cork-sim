...
amm_eth    = st.number_input("AMM ETH liquidity",   10_000.0, 1_000_000.0, 5_000.0)
amm_token  = st.number_input("AMM token liquidity", 10_000.0, 1_000_000.0, 5_000.0)
...
if st.button("▶️ Run simulation"):
    ...
    minutes = res["summary"]["blocks_under_peg"] * 12 / 60
    st.success(
